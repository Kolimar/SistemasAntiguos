...
Route::group(['middleware' => ['auth:api','client.credentials','habilitacion']], function () {
	...
	Route::get('logContenedores', 'Contenedor\ContenedorController@log');
	Route::get('logBooking', 'Bookings\BookingsController@log');


	Route::get('ContenedoresLista', 'Contenedor\ContenedorController@listar');
	Route::put('editcontenedor', 'Contenedor\ContenedorController@editar');
	Route::put('cargaMovimiento', 'Movimientos\MovimientosController@store');
	
	Route::get('Contenedores', 'Contenedor\ContenedorController@index');
	Route::get('Bookings', 'Bookings\BookingsController@index');
	Route::get('Clientes', 'Clientes\ClientesController@index');
	Route::get('depositos', 'depositos\depositosController@index');
	Route::get('Movimientos', 'Movimientos\MovimientosController@index');
	Route::get('Operadores', 'Operadores\OperadoresController@index');
	Route::get('Terminales', 'Terminales\TerminalesController@index');
	Route::get('Transportista', 'Transportista\TransportistaController@index');
...
Route::post('contrasenia','User\UserController@reqPass');
