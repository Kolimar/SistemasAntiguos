...
@Component({
  selector: 'app-panel-booking',
  templateUrl: './panel-booking.component.html',
  styleUrls: ['./panel-booking.component.scss']
})
export class PanelBookingComponent implements OnInit {
