...
class RolContacto extends Model
{
  ...
  protected $table = 'roles_contactos';
    ...
    // MUCHOS ROLES DE CONTACTOS PUEDEN ESTAR EN MUCHOS BRIEFS
    public function contactos()
    {
        return $this->belongsToMany('App\Contacto', 'contactos_roles', 'id_rol_contacto', 'id_contacto');
    }
