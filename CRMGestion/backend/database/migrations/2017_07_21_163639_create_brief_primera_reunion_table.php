...
class CreateBriefPrimeraReunionTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('briefs_primera_reunion', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('briefs_primera_reunion');
    }
}
