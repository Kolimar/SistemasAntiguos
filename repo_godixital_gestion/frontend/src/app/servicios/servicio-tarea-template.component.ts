...
import { ServicioTareaTemplateService, TareaService } from '../services/index';
...
@Component({
    moduleId: module.id,
    selector: 'servicio-tarea-template',
    templateUrl: './servicio-tarea-template.html',
    providers: [ServicioTareaTemplateService, TareaService, AlertServer]
})

export class ServicioTareaTemplateComponent implements OnInit{
    ...
    constructor(
        ...
        private servicio: ServicioTareaTemplateService,
    ...
    // CARGA AUTOMATICA ASOCIADO AL ID SERVICIOS
    ngOnInit(){
        this.loadFilter();
        ...
        if(this.formCreacion.valid && this.isSubmitTareaTemplate){
            ...
            .subscribe(
                data => {
                    ...
                    this.router.navigate(['/servicios-tareas-templates/', this.selectedId, this.selectedName]);
                    this.loader= false;
                    this.isSubmitTareaTemplate= false;
                    this.resetCreateForm();
                },
